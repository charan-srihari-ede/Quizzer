...
import com.example.test_quiz.Model.Result;
...
//                setAlertDialog(answerText);
                dialogStart();
                NotificationCompat.Builder builder=new NotificationCompat.Builder(AttemptTest.this,"Notification")
                        .setSmallIcon(R.drawable.ic_appicon)
                        .setContentTitle("Quizzer")
                        .setContentText("your submission was recieved view results")
                        .setPriority(NotificationCompat.PRIORITY_DEFAULT)
                        .setAutoCancel(true);
                Intent j=new Intent(AttemptTest.this, ResultsAdmin.class);
                j.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                PendingIntent p=PendingIntent.getActivity(AttemptTest.this,0,j,PendingIntent.FLAG_UPDATE_CURRENT);
